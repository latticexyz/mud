...
const VideoModal = ({ isOpen, onClose, videoId }: VideoModalProps) => (
  <DialogPrimitive.Root open={isOpen} onOpenChange={onClose}>
    <DialogPrimitive.Portal>
      <DialogPrimitive.Overlay className="fixed z-40 inset-0 bg-black bg-opacity-70 backdrop-blur-sm" />
      {/* eslint-disable-next-line max-len */}
      <DialogPrimitive.Content className="fixed z-50 left-1/2 top-1/2 w-full max-w-6xl -translate-x-1/2 -translate-y-1/2 transform rounded-lg shadow-xl focus:outline-none">
