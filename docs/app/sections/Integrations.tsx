    ...
    <Section className="bg-black py-8 lg:pt-12 lg:pb-14">
      <Container>
        <div className="flex flex-col lg:flex-row justify-between">
          ...
          <div className="lg:flex hidden gap-4 sm:h-[50px] mt-8 lg:mt-0">
            <a
        ...
        <div className="flex flex-col sm:flex-row gap-4 md:h-[50px] mt-6 md:hidden">
          <a
            href="https://lattice.xyz/quarry"
            rel="noopener noreferrer"
            target="_blank"
            className="text-sm p-4 flex-1 leading-none font-mono uppercase bg-[#F1A50E] text-white inline-flex items-center gap-3.5"
          >
            <Image src="/images/logos/quarry-white.svg" alt="Quarry" width={21} height={21} />
            Explore Quarry
          </a>
          <a
            ...
            rel="noopener noreferrer"
            target="_blank"
            className="text-sm p-4 flex-1 leading-none font-mono uppercase inline-flex items-center gap-3.5 border border-mud text-mud"
          >
            <Image src="/images/logos/mud-transparent.svg" alt="MUD" width={21} height={21} />
            Read MUD docs
          </a>
