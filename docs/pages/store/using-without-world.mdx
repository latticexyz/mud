...
<aside style={{ padding: "1em", border: "2px dashed #ddd", borderRadius: "1em" }}>
  ⚠️ If you use the MUD framework, you don’t have to install Store into your contract. Each World automatically comes
  with a Store. This *Installation* section is meant to be for developers who **do not** use the MUD framework and the
  MUD World.
</aside>
