...
<aside>
  ℹ️ the output directory of the library depends on your Foundry `src` directory and the optional `directory` property
  in the table object of your config. The file name will always be the table name in the config.
</aside>
