...
<aside>
⚠️ If you use the MUD framework, you don’t have to install Store into your contract. Each World automatically comes with a Store. This *Installation* section is meant to be for developers who **do not** use the MUD framework and the MUD World.
...
<aside>
ℹ️ the output directory of the library depends on your Foundry `src` directory and the optional `directory` property in the table object of your config. The file name will always be the table name in the config.
</aside>
