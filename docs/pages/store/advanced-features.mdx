...
Store also supports “Singleton” tables, which are tables with a single record. Singleton tables don’t have primary keys. 
...
TradeExectuted.emitEphemeral("0x1234", TradeExecutedData({
  amount: 10,
  receiver: "0x5678",
}));
```
