...
At this point you will see the option of choosing a template—as of writing the four options are **vanilla**, **react**, **phaser**, and **three**. For the sake of this tutorial any of them works, but examples from the **vanilla** template will be used here.
