...
MUDv2 exposes a different base data-model: **tables**. However, it is quite easy to model your state in the ECS way, and use client-side data-store like [`recs`](/client/recs) to query your state in an ECS-native way.
