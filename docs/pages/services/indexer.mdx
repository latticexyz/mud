...
1. To verify the installation, run `psql` and then:
   ...
   - List the schemas.
     ...
     ```
                        ...
                        Name                    |       Owner
      --------------------------------------------+-------------------
      0x4f4ddafbc93cf8d11a253f21ddbcf836139efdec | qbzzt
      mud                                        | qbzzt
   ...
   - Connect to the schema for your world.
     ...
     ```sql copy
     set search_path to "0x4f4ddafbc93cf8d11a253f21ddbcf836139efdec";
     ```
   ...
   - Get the list of tables.
     ...
     --------------------------------------------+---------------------------+-------+-------
     0x4f4ddafbc93cf8d11a253f21ddbcf836139efdec | name_component            | table | qbzzt
     0x4f4ddafbc93cf8d11a253f21ddbcf836139efdec | player_component          | table | qbzzt
     0x4f4ddafbc93cf8d11a253f21ddbcf836139efdec | position_componen         | table | qbzzt
     0x4f4ddafbc93cf8d11a253f21ddbcf836139efdec | store__resource_ids       | table | qbzzt
     0x4f4ddafbc93cf8d11a253f21ddbcf836139efdec | store__store_hooks        | table | qbzzt
     0x4f4ddafbc93cf8d11a253f21ddbcf836139efdec | store__tables             | table | qbzzt
     0x4f4ddafbc93cf8d11a253f21ddbcf836139efdec | tasks                     | table | qbzzt
     0x4f4ddafbc93cf8d11a253f21ddbcf836139efdec | world__balances           | table | qbzzt
     0x4f4ddafbc93cf8d11a253f21ddbcf836139efdec | world__function_selector  | table | qbzzt
     0x4f4ddafbc93cf8d11a253f21ddbcf836139efdec | world__function_signatur  | table | qbzzt
     0x4f4ddafbc93cf8d11a253f21ddbcf836139efdec | world__init_module_addres | table | qbzzt
     0x4f4ddafbc93cf8d11a253f21ddbcf836139efdec | world__installed_modules  | table | qbzzt
     0x4f4ddafbc93cf8d11a253f21ddbcf836139efdec | world__namespace_delegat  | table | qbzzt
     0x4f4ddafbc93cf8d11a253f21ddbcf836139efdec | world__namespace_owner    | table | qbzzt
     0x4f4ddafbc93cf8d11a253f21ddbcf836139efdec | world__resource_access    | table | qbzzt
     0x4f4ddafbc93cf8d11a253f21ddbcf836139efdec | world__system_hooks       | table | qbzzt
     0x4f4ddafbc93cf8d11a253f21ddbcf836139efdec | world__system_registry    | table | qbzzt
     0x4f4ddafbc93cf8d11a253f21ddbcf836139efdec | world__systems            | table | qbzzt
     0x4f4ddafbc93cf8d11a253f21ddbcf836139efdec | world__user_delegation_co | table | qbzzt
     (19 rows)
     ```
...
```sh copy
curl 'http://localhost:3001/trpc/findAll?batch=1&input=%7B%220%22%3A%7B%22json%22%3A%7B%22chainId%22%3A31337%2C%22address%22%3A%220x4f4ddafbc93cf8d11a253f21ddbcf836139efdec%22%7D%7D%7D' | jq
```
...
Meaning that query 0 is for everything in the `World` at address `0x4f4ddafbc93cf8d11a253f21ddbcf836139efdec`, on the chain with chain ID `31337`.
...
### Reading SkyStrife information

Information about SkyStrife is available from [`https://indexer.skystrife.xyz`].
The world address is `0x7203e7adfdf38519e1ff4f8da7dcdc969371f377`.

1. Run these commands to get the information.

   ```sh copy
   WORLD_ADDRESS=0x7203e7adfdf38519e1ff4f8da7dcdc969371f377
   CHAIN_ID=17001
   INPUT_TEMPLATE=%7B%0A%20%20%220%22%3A%20%7B%0A%20%20%20%20%22json%22%3A%20%7B%0A%20%20%20%20%20%20%22chainId%22%3A%20:CHAIN_ID:%2C%0A%20%20%20%20%20%20%22address%22%3A%20%22:WORLD_ADDRESS:%22%0A%20%20%20%20%7D%0A%20%20%7D%0A%7D
   INPUT=`echo $INPUT_TEMPLATE | sed s/:CHAIN_ID:/$CHAIN_ID/ | sed s/:WORLD_ADDRESS:/$WORLD_ADDRESS/`
   URL="https://indexer.skystrife.xyz/trpc/findAll?batch=1&input=$INPUT"
   curl $URL > data.json
   ```
