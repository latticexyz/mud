...
There are two main mechanisms you can use to read information from MUD:
...
In most cases, we recommend that client use the Indexer to get the state when they are started, and then follow the block chain directly using the events.
