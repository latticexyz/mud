...
You can see an example of an indexer client [here](https://github.com/latticexyz/mud-examples/tree/main/indexer_client).
To execute it:

1. Download and build the example.

   ```sh copy
   git clone https://@github.com/latticexyz/mud-examples.git
   cd mud-examples/indexer_client
   pnpm install
   ```
