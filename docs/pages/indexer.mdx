...
1. Run a test world.
   ...
   **Note**: While MUD v2 is in alpha, we might need to change the data definitions.
   To ensure your world is compatible with the indexer, use `mud@main` to create it, instead of ~`mud@next`~.
