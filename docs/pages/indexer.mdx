...
{
  id: '0x6e9474e9c83676b9a71133ff96db43e7aa0a4342____Counter',
...
1. Read the result and enter `node`:
   ...
   ```sh copy
   curl 'http://localhost:3001/findAll?batch=wd&input=%7B%220%22%3A%7B%22json%22%3A%7B%22chainId%22%3A31337%2C%22address%22%3A%220x6e9474e9c83676b9a71133ff96db43e7aa0a4342%22%7D%7D%7D' > res.json
   node
   ```
...
1. The schema for a world is `<address>__`.
   ...
   ```sql copy
   \dt "0x6e9474e9c83676b9a71133ff96db43e7aa0a4342__".*
   ```
