...
export RPC_HTTP_URL=https://eth-sepolia.g.alchemy.com/v2/1UXrHlWCn5SOzC-ogNpKOAWs5mVqBCqc
export RPC_WS_URL=wss://eth-sepolia.g.alchemy.com/v2/1UXrHlWCn5SOzC-ogNpKOAWs5mVqBCqc
export START_BLOCK=418512
