...
- [State sync (TypeScript edition)](tutorials/walkthrough/sync-ts):
  In this tutorial you learn how MUD synchronizes the `World` state between the blockchain and the local client copy.
  While the code explored and explained is in TypeScript, the general concepts and algorithms are applicable to any computer language and client framework.
