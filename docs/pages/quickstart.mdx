...
- [Node.js v18](https://nodejs.org/en/download/package-manager).
  ...
  <Tabs items={["Linux and MacOS", "Windows"]}>
    <Tab>
      ```sh copy curl -o- https://raw.githubusercontent.com/nvm-sh/nvm/v0.39.7/install.sh | bash nvm install 18 ```
    </Tab>

    <Tab>
      ```powershell copy # installs Chocolatey (Windows Package Manager) Set-ExecutionPolicy Bypass -Scope Process
      ...
      download and install Node.js choco install nodejs --version="18.19.1" ```
    </Tab>
  </Tabs>
