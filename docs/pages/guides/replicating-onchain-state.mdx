...
<Callout type="info" emoji="ⓘ">
  In most cases, you would use a pre-written [template](/templates), which includes code to synchronize information.
  If that is not an option, you might be able to use [an indexer](/indexer) to retrieve the onchain data.

This guide is mostly provided as an illustration, and to simplify the writing of future clients.
