...
We modify the React template to pay accounts that complete todo items.
...
1. Scroll up to see the token address and add it to .env as `TOKEN_ADDRESS`.
   ...
   TOKEN_ADDRESS=0x67671478a98e62381bf90cDd328cFFcDdd26c83A
   ```
