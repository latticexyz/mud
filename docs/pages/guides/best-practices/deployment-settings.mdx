...
If not, [transfer ownership](https://github.com/latticexyz/mud/blob/main/packages/world/src/modules/init/implementations/AccessManagementSystem.sol#L50-L74) of the root namespace to AWS KMS as early as possible.

## After the deployment

- [Verify the contracts](/cli/verify) as soon as possible after deployment.
  The more time passes, the more likely something is to change, which could make verification harder.
