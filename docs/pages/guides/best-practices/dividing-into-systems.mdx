...
It is usually simplest to keep all the logic that needs the same permissions and lives in the same namespace in a single `System`.
Here is a decision tree to help
