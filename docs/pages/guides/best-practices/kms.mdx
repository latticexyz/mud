...
1. Click **Show** to see the access key and keep the access key and secret access key in a safe place.
   ...
   | -------------------- | ---------------------------------------- |
   | AKIAU6GD2Q2VKHWMD4UM | 5XhheI1N7DEaAdjoRWViq6hwnF37Z0JvxMAUMPY3 |
...
1. Set the AWS environment variables.
   ...
   | Variable              | Value                                                                                         |
   | --------------------- | --------------------------------------------------------------------------------------------- |
   | AWS_ACCESS_KEY_ID     | The access key you created, such as `AKIAU6GD2Q2VKHWMD4UM`                                    |
   | AWS_SECRET_ACCESS_KEY | The secret access key, such as `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`                     |
