...
- It is possible, although complicated, to overwrite information in tables.
  This means, for example, that a root namespace `System` can create [any delegation that it wants](/world/account-delegation) by modifying `world__UserDelegationControl`.
