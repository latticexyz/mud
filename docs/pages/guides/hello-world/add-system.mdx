...
1.  Edit `packages/client/src/mud/createSystemCalls.ts` to include `decrement`.
    ...
    <CollapseCode>
        ...
        ```typescript filename="createSystemCalls.ts" copy showLineNumbers {46-50,54}
        /*
        ...
        */
        ...
        export function createSystemCalls(
          ...
          *   syncToRecs (https://github.com/latticexyz/mud/blob/main/templates/vanilla/packages/client/src/mud/setupNetwork.ts#L77-L83).
          */
...
1.  Update `packages/client/src/index.ts` to include `decrement`.
    ...
    <CollapseCode>
        ...
        ```typescript filename="index.ts" copy showLineNumbers {6,18}
