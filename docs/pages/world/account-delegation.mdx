...
Worlds supports account delegation enabling systems be called on behalf of an address.

**Security** - Be careful delegating accounts as it opens the potential for bad actors to do unwanted system calls.

### Use Cases

- Cover gas (transaction) cost
- Create sessions where gas is covered during gameplay
- Enables a user to use multiple wallet for transactions
