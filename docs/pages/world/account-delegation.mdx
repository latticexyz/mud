...
While there are some overlaps in use cases between [ERC-4337](https://www.erc4337.io/) and delegation, they are different things.
In ERC-4337 you create a smart contract and all your transactions appear to come from that contract's address.
Essentially, that contract becomes your identity, and a different smart contract, for example a `World`, cannot associate it automatically with your previous identity.

Our delegation allows any account to be a delegatee.
This means you can continue to use your existing account in a `World`, and just delegate to a temporary session wallet, an [ERC-4337 account contract](https://www.erc4337.io/docs/understanding-ERC-4337/architecture), or any other entity.
