...
The weird `�` characters you see are where the value of a byte is zero.
...
We include a function, [`hexToResource`](https://github.com/latticexyz/mud/blob/main/packages/common/src/hexToResource.ts), that interprets resource IDs for you.

```ts
import { hexToResource } from "@latticexyz/common";

let sampleResourceId: Array<String> = [
  ...
  "0x6f74776f726c6400000000000000000046756e6374696f6e5369676e61747572", // offline table
  "0x737900000000000000000000000000004163636573734d616e6167656d656e74", // system
];

sampleResourceId.map((x) => {
  console.log("----------");
  console.log(hexToResource(x));
});
```
