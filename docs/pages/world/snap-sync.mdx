...
There are two main ways of syncing MUD clients. Snap sync allows you to "fast forward" and fetch the state of the chain.

First, you need to install snap sync globally, and keysInTable on all of your tables

That's all you need to do contract
