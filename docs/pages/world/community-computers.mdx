...
<aside>
  ℹ️ If you don’t care about permissionless extension of applications, it is still recommended using World as a
  MUD-native way of managing contract upgrades and splitting logic into different contracts to avoid the Spurious Dragon
  contract size limit.
</aside>
