...
```solidity filename="packages/contracts/src/systems/MapSystem.sol" {5-6,26} copy showLineNumbers
// SPDX-License-Identifier: MIT
...
```solidity filename="packages/contracts/src/systems/MapSystem.sol" {5-7,33} copy showLineNumbers
// SPDX-License-Identifier: MIT
pragma solidity >=0.8.21;
