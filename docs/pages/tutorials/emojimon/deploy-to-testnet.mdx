...
We recommend reading the full [deployment guide](/cli#deploy) to learn more about the MUD deploy process and our testnets.
...
We'll be adding more deployment guides for providers like [Vercel](https://vercel.com/) in the near future. Stay tuned!
