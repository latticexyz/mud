...
1. Download the source code and install the necessary packages.
   ...
   ```sh copy
   https://github.com/latticexyz/mud.git
...
1. Set `CLIENT_ADDR` to the address to which the contract is deployed.
   On the first deployment to a new Anvil instance, this is `0xb19b36b1456E65E3A6D514D3F715f204BD59f431`.
...
The constructor provides its value.
