...
library NumberList {
  ...
  function pop() internal {
    ...
    StoreSwitch.popFromField(_tableId, _keyTuple, 0, 4, getValueFieldLayout());
  }
  ...
  function pop(IStore _store) internal {
    ...
    _store.popFromField(_tableId, _keyTuple, 0, 4, getValueFieldLayout());
  }
  ...
  function update(IStore _store, uint256 _index, uint32 _element) internal {
    ...
    unchecked {
      _store.updateInField(_tableId, _keyTuple, 0, _index * 4, abi.encodePacked((_element)), getValueFieldLayout());
    }
  }
