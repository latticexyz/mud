...
library Multi {
  ...
  function setNum(uint32 a, bool b, uint256 c, int120 d, int256 num) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 0, abi.encodePacked((num)), getValueFieldLayout());
  }
  ...
  function setNum(IStore _store, uint32 a, bool b, uint256 c, int120 d, int256 num) internal {
    ...
    _store.setField(_tableId, _keyTuple, 0, abi.encodePacked((num)), getValueFieldLayout());
  }
  ...
  function setValue(uint32 a, bool b, uint256 c, int120 d, bool value) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 1, abi.encodePacked((value)), getValueFieldLayout());
  }
  ...
  function setValue(IStore _store, uint32 a, bool b, uint256 c, int120 d, bool value) internal {
    ...
    _store.setField(_tableId, _keyTuple, 1, abi.encodePacked((value)), getValueFieldLayout());
  }
