...
struct StaticArrayWithNumberData {
  uint256 num;
  uint256[3] value;
}

library StaticArrayWithNumber {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "StaticArrayWithN", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000005374617469634172726179576974684e);
   ...
   */
  function get() internal view returns (StaticArrayWithNumberData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Get the full data.
   */
  function _get() internal view returns (StaticArrayWithNumberData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   */
  function set(StaticArrayWithNumberData memory _table) internal {
   ...
   * @notice Set the full data using the data struct.
   */
  function _set(StaticArrayWithNumberData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.num);
  ...
  ) internal pure returns (StaticArrayWithNumberData memory _table) {
