...
library Vector {
   ...
   * @notice Get the full data.
   */
  function get(bytes32[] memory _keyTuple) internal view returns (VectorData memory _table) {
    (bytes memory _staticData, PackedCounter _encodedLengths, bytes memory _dynamicData) = StoreSwitch.getRecord(
      _tableId,
      _keyTuple,
      _fieldLayout
   ...
   * @notice Get the full data.
   */
  function _get(bytes32[] memory _keyTuple) internal view returns (VectorData memory _table) {
    (bytes memory _staticData, PackedCounter _encodedLengths, bytes memory _dynamicData) = StoreCore.getRecord(
      _tableId,
      _keyTuple,
      _fieldLayout
   ...
   * @notice Set the full data using individual values.
   */
  function set(bytes32[] memory _keyTuple, int32 x, int32 y) internal {
    bytes memory _staticData = encodeStatic(x, y);
   ...
   * @notice Set the full data using individual values.
   */
  function _set(bytes32[] memory _keyTuple, int32 x, int32 y) internal {
    bytes memory _staticData = encodeStatic(x, y);
   ...
   * @notice Set the full data using the data struct.
   */
  function set(bytes32[] memory _keyTuple, VectorData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.x, _table.y);
   ...
   * @notice Set the full data using the data struct.
   */
  function _set(bytes32[] memory _keyTuple, VectorData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.x, _table.y);
