...
library Score {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "royale", name: "Score", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462726f79616c65000000000000000053636f72650000000000000000000000);
