...
library NameValue {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "a", name: "NameValue", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746261000000000000000000000000004e616d6556616c756500000000000000);
