...
import { ASystemThing2, ASystemThing } from "../../ASystemTypes.sol";
...
library ASystemLib {
  ...
  function setComplexValue(ASystemType self, ASystemThing2 memory value, string memory name) internal {
    return CallWrapper(self.toResourceId(), address(0)).setComplexValue(value, name);
  }
  ...
  function setComplexValue(CallWrapper memory self, ASystemThing2 memory value, string memory name) internal {
    ...
    bytes memory systemCall = abi.encodeWithSelector(
      bytes4(keccak256("setComplexValue((uint256,uint256,uint256),string)")),
      value.a,
      value.b,
      value.c,
      name
  ...
  function setValue(CallWrapper memory self, ASystemThing memory value) internal {
    ...
    bytes memory systemCall = abi.encodeWithSelector(bytes4(keccak256("setValue((uint256))")), value.a);
    self.from == address(0)
      ? _world().call(self.systemId, systemCall)
      : _world().callFrom(self.from, self.systemId, systemCall);
  }
  ...
  function setValue(CallWrapper memory self, uint256 value) internal {
    ...
    bytes memory systemCall = abi.encodeWithSelector(bytes4(keccak256("setValue(uint256)")), value);
    self.from == address(0)
      ? _world().call(self.systemId, systemCall)
      : _world().callFrom(self.from, self.systemId, systemCall);
  }
  ...
  function getValue(CallWrapper memory self) internal view returns (uint256) {
    ...
    bytes memory systemCall = abi.encodeWithSelector(bytes4(keccak256("getValue()")));
  ...
  function getTwoValues(CallWrapper memory self) internal view returns (uint256, uint256) {
    ...
    bytes memory systemCall = abi.encodeWithSelector(bytes4(keccak256("getTwoValues()")));
    bytes memory worldCall = self.from == address(0)
      ? abi.encodeCall(IWorldCall.call, (self.systemId, systemCall))
      : abi.encodeCall(IWorldCall.callFrom, (self.from, self.systemId, systemCall));
    (bool success, bytes memory returnData) = address(_world()).staticcall(worldCall);
  ...
  function setAddress(CallWrapper memory self) internal returns (address) {
    ...
    bytes memory systemCall = abi.encodeWithSelector(bytes4(keccak256("setAddress()")));
  ...
  function setComplexValue(RootCallWrapper memory self, ASystemThing2 memory value, string memory name) internal {
    bytes memory systemCall = abi.encodeWithSelector(
      bytes4(keccak256("setComplexValue((uint256,uint256,uint256),string)")),
      value.a,
      value.b,
