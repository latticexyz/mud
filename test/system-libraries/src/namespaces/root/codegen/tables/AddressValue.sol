...
library AddressValue {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "AddressValue", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004164647265737356616c756500000000);
