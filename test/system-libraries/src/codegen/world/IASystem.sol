...
import { ASystemThing2, ASystemThing } from "../../namespaces/a/ASystemTypes.sol";
 ...
 */
interface IASystem {
  function a__setComplexValue(ASystemThing2 memory value, string memory name) external;
