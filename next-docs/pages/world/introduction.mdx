...
If you want to prove that only an authorized `System` will ever be able to change table data, you can revoke all access to the root namespace and change the owner to `address(0)`.
