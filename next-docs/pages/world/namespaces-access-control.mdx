...
- If ownership is transferred to the 0 address, it's considered burned. After this happens, no new resources can be registered in the namespace, access can't be changed, and ownership can't be transferred again.
