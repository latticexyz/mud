...
The vanilla template uses standard HTML and JavaScript to communicate with the user.
...
Create [an HTML span](https://www.w3schools.com/tags/tag_span.asp) that JavaScript code can update.
...
This function emits [a log message](https://www.w3schools.com/jsref/met_console_log.asp) and then updates the `counter` span.
