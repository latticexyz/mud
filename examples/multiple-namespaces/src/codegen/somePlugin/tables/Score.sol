...
library Score {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "somePlugin", name: "Score", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462736f6d65506c7567696e0000000053636f72650000000000000000000000);
   ...
   * @notice Get score.
   */
  function getScore(address player) internal view returns (uint256 score) {
   ...
   * @notice Get score.
   */
  function _getScore(address player) internal view returns (uint256 score) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Get score.
   */
  function _get(address player) internal view returns (uint256 score) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Set score.
   */
  function setScore(address player, uint256 score) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Set score.
   */
  function _setScore(address player, uint256 score) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
   ...
   * @notice Set score.
   */
  function _set(address player, uint256 score) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(player)));
