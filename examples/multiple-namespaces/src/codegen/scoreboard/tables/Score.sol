...
library Score {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "scoreboard", name: "Score", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746273636f7265626f6172640000000053636f72650000000000000000000000);
