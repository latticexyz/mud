...
library Score {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "some-plugin", name: "Score", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462736f6d652d706c7567696e00000053636f72650000000000000000000000);
