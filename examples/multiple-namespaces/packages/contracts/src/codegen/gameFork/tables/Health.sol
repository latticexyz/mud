...
library Health {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "gameFork", name: "Health", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746267616d65466f726b0000000000004865616c746800000000000000000000);
