...
library MessageTable {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "royale", name: "MessageTable", typeId: RESOURCE_OFFCHAIN_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x6f74726f79616c6500000000000000004d6573736167655461626c6500000000);
