...
library CounterTable {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "royale", name: "CounterTable", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462726f79616c650000000000000000436f756e7465725461626c6500000000);
