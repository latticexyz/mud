...
library Checked {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "app", name: "Checked", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626170700000000000000000000000436865636b6564000000000000000000);
