...
library LibUtils {
  ...
  function distanceBetween(
    ...
    uint256 e1,
    uint256 e2,
    uint256 positionComponentId
  ) internal view returns (int32) {
    CoordComponent positionComponent = CoordComponent(getAddressById(components, positionComponentId));
  ...
  function getEntityAt(
    ...
    uint256 positionComponentId
  ) internal view returns (uint256, bool found) {
