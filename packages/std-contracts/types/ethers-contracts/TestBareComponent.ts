...
export type TestStructBareStruct = {
  a: PromiseOrValue<BigNumberish>;
  b: PromiseOrValue<BigNumberish>;
  c: PromiseOrValue<string>;
  d: PromiseOrValue<string>;
};

export type TestStructBareStructOutput = [BigNumber, number, string, string] & {
  a: BigNumber;
  b: number;
  c: string;
  d: string;
...
export interface TestBareComponentInterface extends utils.Interface {
  functions: {
    ...
    "set(uint256,(uint256,int32,address,string))": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "remove"
      | "set(uint256,bytes)"
      | "set(uint256,(uint256,int32,address,string))"
      | "transferOwnership"
      | "unauthorizeWriter"
      | "world"
      | "writeAccess"
  ...
  encodeFunctionData(
    functionFragment: "set(uint256,(uint256,int32,address,string))",
    values: [PromiseOrValue<BigNumberish>, TestStructBareStruct]
  ): string;
  encodeFunctionData(
...
export interface TestBareComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestBareComponentInterface;
  ...
  functions: {
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[TestStructBareStructOutput]>;
