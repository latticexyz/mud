...
export type TestStructStructOutput = [BigNumber, number, string, string] & {
  a: BigNumber;
  b: number;
  c: string;
  d: string;
...
export interface TestComponentInterface extends utils.Interface {
  functions: {
    ...
    "getEntitiesWithValue((uint256,int32,address,string))": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "getEntitiesWithValue((uint256,int32,address,string))"
      | "getRawValue"
      | "getSchema"
      | "getValue"
      | "has"
  ...
  encodeFunctionData(
    functionFragment: "getEntitiesWithValue((uint256,int32,address,string))",
    values: [TestStructStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<BigNumberish>, TestStructStruct]
  ): string;
  encodeFunctionData(
...
export interface TestComponent extends BaseContract {
  ...
  functions: {
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[TestStructStructOutput]>;
