...
export type GroupLogsByBlockNumberResult<TLog extends Log<bigint, number, false>> = {
 ...
 */
export function groupLogsByBlockNumber<TLog extends Log<bigint, number, false>>(
  logs: readonly TLog[],
  toBlock?: BlockNumber
