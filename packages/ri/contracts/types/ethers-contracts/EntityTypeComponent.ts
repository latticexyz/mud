...
export type EntityTypeStruct = { entityType: BigNumberish };

export type EntityTypeStructOutput = [BigNumber] & { entityType: BigNumber };

export interface EntityTypeComponentInterface extends utils.Interface {
  contractName: "EntityTypeComponent";
  functions: {
  ...
  encodeFunctionData(functionFragment: "getEntitiesWithValue", values: [EntityTypeStruct]): string;
  ...
  encodeFunctionData(functionFragment: "set", values: [BigNumberish, EntityTypeStruct]): string;
...
export interface EntityTypeComponent extends BaseContract {
  ...
  functions: {
    ...
    "getEntitiesWithValue((uint256))"(position: EntityTypeStruct, overrides?: CallOverrides): Promise<[BigNumber[]]>;
    ...
    getValue(entity: BigNumberish, overrides?: CallOverrides): Promise<[EntityTypeStructOutput]>;
  ...
  callStatic: {
    ...
    "set(uint256,(uint256))"(entity: BigNumberish, value: EntityTypeStruct, overrides?: CallOverrides): Promise<void>;
