...
export interface LearnedSpellsComponentInterface extends utils.Interface {
  contractName: "LearnedSpellsComponent";
  functions: {
  ...
  encodeFunctionData(functionFragment: "getEntitiesWithValue", values: [BigNumberish[]]): string;
...
export interface LearnedSpellsComponent extends BaseContract {
  contractName: "LearnedSpellsComponent";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LearnedSpellsComponentInterface;
  ...
  functions: {
    ...
    "getEntitiesWithValue(uint256[])"(learnedSpells: BigNumberish[], overrides?: CallOverrides): Promise<[BigNumber[]]>;
  ...
  callStatic: {
    ...
    "set(uint256,uint256[])"(entity: BigNumberish, value: BigNumberish[], overrides?: CallOverrides): Promise<void>;
