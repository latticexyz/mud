...
export type OwnedByStruct = { ownedBy: BigNumberish };

export type OwnedByStructOutput = [BigNumber] & { ownedBy: BigNumber };
...
export interface OwnedByComponentInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "getEntitiesWithValue", values: [OwnedByStruct]): string;
  ...
  encodeFunctionData(functionFragment: "set", values: [BigNumberish, OwnedByStruct]): string;
...
export interface OwnedByComponent extends BaseContract {
  ...
  functions: {
    ...
    "getEntitiesWithValue((uint256))"(ownedBy: OwnedByStruct, overrides?: CallOverrides): Promise<[BigNumber[]]>;
    ...
    getValue(entity: BigNumberish, overrides?: CallOverrides): Promise<[OwnedByStructOutput]>;
  ...
  callStatic: {
    ...
    "set(uint256,(uint256))"(entity: BigNumberish, value: OwnedByStruct, overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    ...
    "getEntitiesWithValue((uint256))"(ownedBy: OwnedByStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;
