...
export interface EmbodiedSystemArgumentComponentInterface extends utils.Interface {
  contractName: "EmbodiedSystemArgumentComponent";
  functions: {
...
export interface EmbodiedSystemArgumentComponent extends BaseContract {
  contractName: "EmbodiedSystemArgumentComponent";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EmbodiedSystemArgumentComponentInterface;
  ...
  callStatic: {
    ...
    set(entity: BigNumberish, value: BytesLike, overrides?: CallOverrides): Promise<void>;
