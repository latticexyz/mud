...
export type PersonaStruct = { personaId: BigNumberish };

export type PersonaStructOutput = [BigNumber] & { personaId: BigNumber };

export interface PersonaComponentInterface extends utils.Interface {
  contractName: "PersonaComponent";
  functions: {
  ...
  encodeFunctionData(functionFragment: "getEntitiesWithValue", values: [PersonaStruct]): string;
  ...
  encodeFunctionData(functionFragment: "set", values: [BigNumberish, PersonaStruct]): string;
...
export interface PersonaComponent extends BaseContract {
  contractName: "PersonaComponent";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PersonaComponentInterface;
  ...
  functions: {
    ...
    "getEntitiesWithValue((uint256))"(persona: PersonaStruct, overrides?: CallOverrides): Promise<[BigNumber[]]>;
    ...
    getValue(entity: BigNumberish, overrides?: CallOverrides): Promise<[PersonaStructOutput]>;
  ...
  callStatic: {
    ...
    "set(uint256,(uint256))"(entity: BigNumberish, value: PersonaStruct, overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    ...
    "getEntitiesWithValue((uint256))"(persona: PersonaStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;
