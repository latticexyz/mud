...
var file_proto_mode_proto_rawDesc = []byte{
	...
	0x64, 0x72, 0x65, 0x6e, 0x22, 0x5d, 0x0a, 0x06, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x12, 0x21,
...
var file_proto_mode_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_proto_mode_proto_goTypes = []interface{}{
	...
	(*Filter)(nil),                         // 11: mode.Filter
	(*FieldPair)(nil),                      // 12: mode.FieldPair
	(*Field)(nil),                          // 13: mode.Field
	(*ProjectedField)(nil),                 // 14: mode.ProjectedField
	nil,                                    // 15: mode.QueryLayerResponse.TablesEntry
}
var file_proto_mode_proto_depIdxs = []int32{
	2,  // 0: mode.GenericTable.rows:type_name -> mode.Row
	15, // 1: mode.QueryLayerResponse.tables:type_name -> mode.QueryLayerResponse.TablesEntry
	...
	11, // 4: mode.FindRequest.filter:type_name -> mode.Filter
	14, // 5: mode.FindRequest.project:type_name -> mode.ProjectedField
	...
	12, // 8: mode.JoinRequest.on:type_name -> mode.FieldPair
	8,  // 9: mode.JoinRequest.children:type_name -> mode.FindRequest
	13, // 10: mode.Filter.field:type_name -> mode.Field
	13, // 11: mode.FieldPair.field1:type_name -> mode.Field
	13, // 12: mode.FieldPair.field2:type_name -> mode.Field
	13, // 13: mode.ProjectedField.field:type_name -> mode.Field
	3,  // 14: mode.QueryLayerResponse.TablesEntry.value:type_name -> mode.GenericTable
	8,  // 15: mode.QueryLayer.Find:input_type -> mode.FindRequest
	10, // 16: mode.QueryLayer.Join:input_type -> mode.JoinRequest
	9,  // 17: mode.QueryLayer.FindAll:input_type -> mode.FindAllRequest
	9,  // 18: mode.QueryLayer.StreamAll:input_type -> mode.FindAllRequest
	8,  // 19: mode.QueryLayer.Count:input_type -> mode.FindRequest
	4,  // 20: mode.QueryLayer.Find:output_type -> mode.QueryLayerResponse
	4,  // 21: mode.QueryLayer.Join:output_type -> mode.QueryLayerResponse
	4,  // 22: mode.QueryLayer.FindAll:output_type -> mode.QueryLayerResponse
	4,  // 23: mode.QueryLayer.StreamAll:output_type -> mode.QueryLayerResponse
	4,  // 24: mode.QueryLayer.Count:output_type -> mode.QueryLayerResponse
...
func file_proto_mode_proto_init() {
	...
	file_proto_mode_proto_msgTypes[14].OneofWrappers = []interface{}{}
	type x struct{}
