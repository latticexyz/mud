...
func buildDatabaseSchema(state *pb.ECSStateSnapshot, dataSchema DataSchema) (string, error) {
...
func loadIntoDatabase(stateSnapshot *pb.ECSStateSnapshot, dataSchema DataSchema, db *sqlx.DB) error {
...
func main() {
	...
	dataSchema := parseDataSchemaFile(*dataSchemaPath)
