...
describe("utils", () => {
  ...
  describe("subscribe", () => {
    ...
    it("should subscribe to updates of the selected table", () => {
      ...
      subscribe(client._tupleDatabaseClient, callback, { table: "Position" });
    ...
    it("should only subscribe to updates greater than the provided key", () => {
      ...
      subscribe(client._tupleDatabaseClient, callback, { table: "Position", key: { gt: { key: "0x01" } } });
    ...
    it("should only subscribe to updates greater than or equal to provided key", () => {
      ...
      subscribe(client._tupleDatabaseClient, callback, { table: "Position", key: { gte: { key: "0x01" } } });
    ...
    it("should only subscribe to updates equal to the provided key", () => {
      ...
      subscribe(client._tupleDatabaseClient, callback, { table: "Position", key: { eq: { key: "0x01" } } });
    ...
    it("should only subscribe to updates less than or equal to the provided key", () => {
      ...
      subscribe(client._tupleDatabaseClient, callback, { table: "Position", key: { lte: { key: "0x01" } } });
    ...
    it("should only subscribe to updates less than the provided key", () => {
      ...
      subscribe(client._tupleDatabaseClient, callback, { table: "Position", key: { lt: { key: "0x01" } } });
    ...
    it("should not subscribe to updates anymore after unsubscribing", () => {
      ...
      const unsubscribe = subscribe(client._tupleDatabaseClient, callback, {
        table: "Position",
        key: { lte: { key: "0x01" } },
      });
