...
import { RawRecord, TableRecord, Tables } from "./common";
          ...
          .map((id) => {
            ...
            return [
              id,
              {
                ...
                key: decodeKey(getSchemaTypes(getKeySchema(table)), rawRecord.keyTuple),
                value: decodeValueArgs(getSchemaTypes(getValueSchema(table)), rawRecord),
