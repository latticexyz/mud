...
export type RawTableRecord<table extends ResolvedTableConfig> = {
...
export type QueryCacheState<table extends ResolvedTableConfig> = {
...
export type QueryCacheStore<table extends ResolvedTableConfig> = UseBoundStore<StoreApi<QueryCacheState<table>>>;

export type CreateStoreOptions<table extends ResolvedTableConfig> = {
  tables: readonly table[];
};

export function createStore<table extends ResolvedTableConfig>(
