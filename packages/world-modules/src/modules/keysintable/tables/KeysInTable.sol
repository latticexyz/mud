...
library KeysInTable {
  ...
  function getItemKeys1(IStore _store, ResourceId sourceTableId, uint256 _index) internal view returns (bytes32) {
    ...
    unchecked {
      bytes memory _blob = _store.getDynamicFieldSliceDefault(_tableId, _keyTuple, 1, _index * 32, (_index + 1) * 32);
      return (bytes32(_blob));
    }
  }
  ...
  function getItemKeys2(IStore _store, ResourceId sourceTableId, uint256 _index) internal view returns (bytes32) {
    ...
    unchecked {
      bytes memory _blob = _store.getDynamicFieldSliceDefault(_tableId, _keyTuple, 2, _index * 32, (_index + 1) * 32);
      return (bytes32(_blob));
    }
  }
  ...
  function getItemKeys3(IStore _store, ResourceId sourceTableId, uint256 _index) internal view returns (bytes32) {
    ...
    unchecked {
      bytes memory _blob = _store.getDynamicFieldSliceDefault(_tableId, _keyTuple, 3, _index * 32, (_index + 1) * 32);
      return (bytes32(_blob));
    }
  }
  ...
  function getItemKeys4(IStore _store, ResourceId sourceTableId, uint256 _index) internal view returns (bytes32) {
    ...
    unchecked {
      bytes memory _blob = _store.getDynamicFieldSliceDefault(_tableId, _keyTuple, 4, _index * 32, (_index + 1) * 32);
      return (bytes32(_blob));
    }
  }
