...
contract MockERC20WithNamespaceBurnable is MockERC20WithNamespace, ERC20Burnable {}
...
contract ERC20BurnableWithNamespaceTest is ERC20WithNamespaceBehaviorTest, ERC20BurnableTest {
  function createToken() internal override returns (MockERC20Base) {
    return new MockERC20WithNamespaceBurnable();
  }
}
