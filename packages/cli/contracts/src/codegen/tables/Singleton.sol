...
library Singleton {
  ...
  function setV2(uint32[2] memory v2) internal {
    ...
    StoreSwitch.setField(_tableId, _keySchema, 1, EncodeArray.encode(fromStaticArray_uint32_2(v2)));
  }
  ...
  function setV2(IStore _store, uint32[2] memory v2) internal {
    ...
    _store.setField(_tableId, _keySchema, 1, EncodeArray.encode(fromStaticArray_uint32_2(v2)));
  }
  ...
  function setV3(uint32[2] memory v3) internal {
    ...
    StoreSwitch.setField(_tableId, _keySchema, 2, EncodeArray.encode(fromStaticArray_uint32_2(v3)));
  }
  ...
  function setV3(IStore _store, uint32[2] memory v3) internal {
    ...
    _store.setField(_tableId, _keySchema, 2, EncodeArray.encode(fromStaticArray_uint32_2(v3)));
  }
  ...
  function setV4(uint32[1] memory v4) internal {
    ...
    StoreSwitch.setField(_tableId, _keySchema, 3, EncodeArray.encode(fromStaticArray_uint32_1(v4)));
  }
  ...
  function setV4(IStore _store, uint32[1] memory v4) internal {
    ...
    _store.setField(_tableId, _keySchema, 3, EncodeArray.encode(fromStaticArray_uint32_1(v4)));
  }
  ...
  function getItemV4(uint256 _index) internal view returns (uint32) {
    ...
    bytes memory _blob = StoreSwitch.getFieldSlice(_tableId, _keySchema, 3, getSchema(), _index * 4, (_index + 1) * 4);
    return (uint32(Bytes.slice4(_blob, 0)));
  }
  ...
  function getItemV4(IStore _store, uint256 _index) internal view returns (uint32) {
    ...
    bytes memory _blob = _store.getFieldSlice(_tableId, _keySchema, 3, getSchema(), _index * 4, (_index + 1) * 4);
    return (uint32(Bytes.slice4(_blob, 0)));
  }
  ...
  function popV4() internal {
    ...
    StoreSwitch.popFromField(_tableId, _keySchema, 3, 4);
  }
  ...
  function popV4(IStore _store) internal {
    ...
    _store.popFromField(_tableId, _keySchema, 3, 4);
  }
  ...
  function updateV4(uint256 _index, uint32 _element) internal {
    ...
    StoreSwitch.updateInField(_tableId, _keySchema, 3, _index * 4, abi.encodePacked((_element)));
  }
  ...
  function updateV4(IStore _store, uint256 _index, uint32 _element) internal {
    ...
    _store.updateInField(_tableId, _keySchema, 3, _index * 4, abi.encodePacked((_element)));
  }
