...
library Singleton {
  ...
  /**
   * @notice Get length of v2 (using the specified store)
   */
  ...
  /**
   * @notice Get length of v3 (using the specified store)
   */
  ...
  /**
   * @notice Get length of v4 (using the specified store)
   */
