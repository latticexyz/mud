...
const handler = (argv) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield (0, utils_1.exec)(`mv ${name}/contracts/foundrytoml.template contracts/foundry.toml`);
    console.log("Setting up remappings...");
    yield (0, utils_1.exec)(`rm ${name}/contracts/remappings.txt`);
    yield (0, utils_1.exec)(`mv ${name}/contracts/remappingstxt.template contracts/remappings.txt`);
    console.log("Setting up compile task...");
    yield (0, utils_1.exec)(`rm ${name}/contracts/tasks/compile.ts`);
    yield (0, utils_1.exec)(`mv ${name}/contracts/tasks/compilets.template contracts/tasks/compile.ts`);
    console.log("Building contracts...");
    yield (0, utils_1.exec)(`cd contracts && yarn build`);
