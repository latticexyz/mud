...
contract StoreCoreTest is Test, StoreMock {
  ...
  function testRegisterAndGetFieldLayout() public {
    ...
    IStore(this).registerTable(tableId, fieldLayout, keySchema, valueSchema, false, keyNames, fieldNames);
  ...
  function testHasFieldLayoutAndSchema() public {
    ...
    IStore(this).registerTable(tableId, fieldLayout, defaultKeySchema, valueSchema, false, keyNames, fieldNames);
  ...
  function testRegisterTableRevertNames() public {
    ...
    IStore(this).registerTable(tableId, fieldLayout, keySchema, valueSchema, false, oneName, oneName);
    ...
    IStore(this).registerTable(tableId, fieldLayout, keySchema, valueSchema, false, fourNames, fourNames);
  }
