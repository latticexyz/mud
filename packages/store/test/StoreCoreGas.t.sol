...
contract StoreCoreGasTest is Test, GasReporter, StoreMock {
  ...
  function testRegisterAndGetFieldLayout() public {
    ...
    StoreCore.getValueFieldLayout(table);
    endGasReport();

    startGasReport("StoreCore: get key schema (warm)");
    StoreCore.getKeyFieldLayout(table);
    endGasReport();
  }
  ...
  function testHasFieldLayout() public {
    ...
    StoreCore.registerTable(table, defaultKeyFieldLayout, valueFieldLayout, new string[](1), new string[](4));
  ...
  function testSetAndGetDynamicDataLength() public {
    ...
    // Register schema
    StoreCore.registerTable(table, defaultKeyFieldLayout, valueFieldLayout, new string[](1), new string[](5));
  ...
  function testSetAndGetStaticData() public {
    ...
    StoreCore.getRecord(table, key, valueFieldLayout);
    endGasReport();
  }
  ...
  function testSetAndGetStaticDataSpanningWords() public {
    ...
    bytes32 table = keccak256("some.table");
    StoreCore.registerTable(table, defaultKeyFieldLayout, valueFieldLayout, new string[](1), new string[](2));
  ...
  function testSetAndGetDynamicData() public {
    ...
    StoreCore.registerTable(table, defaultKeyFieldLayout, valueFieldLayout, new string[](1), new string[](3));
  ...
  function testSetAndGetField() public {
    ...
    StoreCore.setField(table, key, 0, firstDataPacked, valueFieldLayout);
    endGasReport();
    ...
    StoreCore.getField(table, key, 0, valueFieldLayout);
    endGasReport();
    ...
    StoreCore.setField(table, key, 1, secondDataPacked, valueFieldLayout);
    endGasReport();

    // Get second field
    startGasReport("get static field (overlap 2 slot)");
    StoreCore.getField(table, key, 1, valueFieldLayout);
    endGasReport();
    ...
    StoreCore.setField(table, key, 2, thirdDataBytes, valueFieldLayout);
    endGasReport();

    // Get third field
    startGasReport("get dynamic field (1 slot, first dynamic field)");
    StoreCore.getField(table, key, 2, valueFieldLayout);
    endGasReport();

    // Set fourth field
    startGasReport("set dynamic field (1 slot, second dynamic field)");
    StoreCore.setField(table, key, 3, fourthDataBytes, valueFieldLayout);
    endGasReport();

    // Get fourth field
    startGasReport("get dynamic field (1 slot, second dynamic field)");
    StoreCore.getField(table, key, 3, valueFieldLayout);
    endGasReport();
  }
  ...
  function testPushToField() public {
    ...
    // Set fields
    StoreCore.setField(table, key, 0, abi.encodePacked(firstDataBytes), valueFieldLayout);
    StoreCore.setField(table, key, 1, secondDataBytes, valueFieldLayout);
    // Initialize a field with push
    StoreCore.pushToField(table, key, 2, thirdDataBytes, valueFieldLayout);
    ...
    StoreCore.pushToField(table, key, 1, secondDataToPush, valueFieldLayout);
    endGasReport();
    ...
    StoreCore.pushToField(table, key, 2, thirdDataToPush, valueFieldLayout);
    endGasReport();
  }
  ...
  function testUpdateInField() public {
    ...
    // Set fields
    StoreCore.setField(table, key, 0, abi.encodePacked(data.firstDataBytes), valueFieldLayout);
    StoreCore.setField(table, key, 1, data.secondDataBytes, valueFieldLayout);
    StoreCore.setField(table, key, 2, data.thirdDataBytes, valueFieldLayout);
    ...
    StoreCore.updateInField(table, key, 1, 4 * 1, data.secondDataForUpdate, valueFieldLayout);
    endGasReport();
    ...
    StoreCore.updateInField(table, key, 2, 8 * 1, data.thirdDataForUpdate, valueFieldLayout);
    endGasReport();
  }
  ...
  function testAccessEmptyData() public {
    ...
    StoreCore.getFieldLength(table, key, 1, valueFieldLayout);
    endGasReport();

    startGasReport("access slice of dynamic field of non-existing record");
    StoreCore.getFieldSlice(table, key, 1, valueFieldLayout, 0, 0);
    endGasReport();
  }
  ...
  function testHooks() public {
    ...
    StoreCore.registerTable(table, defaultKeyFieldLayout, valueFieldLayout, new string[](1), new string[](1));
    ...
    StoreCore.setField(table, key, 0, data, valueFieldLayout);
    endGasReport();
  ...
  function testHooksDynamicData() public {
    ...
    StoreCore.setField(table, key, 1, arrayDataBytes, valueFieldLayout);
    endGasReport();
