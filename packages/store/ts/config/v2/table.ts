...
export type validateTableShorthand<input, scope extends AbiTypeScope = AbiTypeScope> = input extends SchemaInput<scope>
...
export type validateTableFull<input, scope extends AbiTypeScope = AbiTypeScope> = input extends TableFullInput<
  SchemaInput<scope>,
  scope
>
  ? {
