...
interface IStoreErrors {
  ...
  error StoreCore_InvalidValueSchemaNamesLength(uint256 expected, uint256 received);
  error StoreCore_InvalidKeySchemaNamesLength(uint256 expected, uint256 received);
