...
library Tables {
  ...
  function _setFieldLayout(bytes32 tableId, bytes32 fieldLayout) internal {
    ...
    StoreCore.setField(_tableId, _keyTuple, 0, abi.encodePacked((fieldLayout)), getFieldLayout());
  }
  ...
  function _setKeySchema(bytes32 tableId, bytes32 keySchema) internal {
    ...
    StoreCore.setField(_tableId, _keyTuple, 1, abi.encodePacked((keySchema)), getFieldLayout());
  }
  ...
  function _setValueSchema(bytes32 tableId, bytes32 valueSchema) internal {
    ...
    StoreCore.setField(_tableId, _keyTuple, 2, abi.encodePacked((valueSchema)), getFieldLayout());
  }
