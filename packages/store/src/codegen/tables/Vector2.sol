...
library Vector2 {
  ...
  function setX(bytes32 key, uint32 x) internal {
    ...
    StoreSwitch.setField(_tableId, _keySchema, 0, abi.encodePacked((x)));
  }
  ...
  function setX(IStore _store, bytes32 key, uint32 x) internal {
    ...
    _store.setField(_tableId, _keySchema, 0, abi.encodePacked((x)));
  }
  ...
  function setY(bytes32 key, uint32 y) internal {
    ...
    StoreSwitch.setField(_tableId, _keySchema, 1, abi.encodePacked((y)));
  }
  ...
  function setY(IStore _store, bytes32 key, uint32 y) internal {
    ...
    _store.setField(_tableId, _keySchema, 1, abi.encodePacked((y)));
  }
