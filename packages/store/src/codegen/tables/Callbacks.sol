...
library Callbacks {
  ...
  function updateValue(bytes32 key, uint256 _index, bytes24 _element) internal {
    ...
    unchecked {
      StoreSwitch.updateInDynamicField(_tableId, _keyTuple, 0, _index * 24, abi.encodePacked((_element)));
    }
  }
  ...
  function _updateValue(bytes32 key, uint256 _index, bytes24 _element) internal {
    ...
    unchecked {
      StoreCore.updateInDynamicField(_tableId, _keyTuple, 0, _index * 24, abi.encodePacked((_element)));
    }
  }
  ...
  function updateValue(IStore _store, bytes32 key, uint256 _index, bytes24 _element) internal {
    ...
    unchecked {
      _store.updateInDynamicField(_tableId, _keyTuple, 0, _index * 24, abi.encodePacked((_element)));
    }
  }
