...
library Callbacks {
  ...
  function pop(bytes32 key) internal {
    ...
    StoreSwitch.popFromField(_tableId, _keyTuple, 0, 24, getValueFieldLayout());
  }
  ...
  function pop(IStore _store, bytes32 key) internal {
    ...
    _store.popFromField(_tableId, _keyTuple, 0, 24, getValueFieldLayout());
  }
  ...
  function update(IStore _store, bytes32 key, uint256 _index, bytes24 _element) internal {
    ...
    unchecked {
      _store.updateInField(_tableId, _keyTuple, 0, _index * 24, abi.encodePacked((_element)), getValueFieldLayout());
    }
  }
