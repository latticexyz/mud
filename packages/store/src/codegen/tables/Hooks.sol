...
library Hooks {
  ...
  /** Get value */
  function getValue(bytes32 _tableId, bytes32 key) internal view returns (bytes21[] memory value) {
  ...
  /** Get value */
  function _getValue(bytes32 _tableId, bytes32 key) internal view returns (bytes21[] memory value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  function getValue(IStore _store, bytes32 _tableId, bytes32 key) internal view returns (bytes21[] memory value) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  /** Set value */
  function setValue(bytes32 _tableId, bytes32 key, bytes21[] memory value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  /** Set value */
  function _setValue(bytes32 _tableId, bytes32 key, bytes21[] memory value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  function setValue(IStore _store, bytes32 _tableId, bytes32 key, bytes21[] memory value) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   */
  function getItemValue(bytes32 _tableId, bytes32 key, uint256 _index) internal view returns (bytes21) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * (unchecked, returns invalid data if index overflows)
   */
  function _getItemValue(bytes32 _tableId, bytes32 key, uint256 _index) internal view returns (bytes21) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * (unchecked, returns invalid data if index overflows)
   */
  function getItemValue(IStore _store, bytes32 _tableId, bytes32 key, uint256 _index) internal view returns (bytes21) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  function pushValue(bytes32 _tableId, bytes32 key, bytes21 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  /** Push an element to value */
  function _pushValue(bytes32 _tableId, bytes32 key, bytes21 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  function pushValue(IStore _store, bytes32 _tableId, bytes32 key, bytes21 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   */
  function updateValue(bytes32 _tableId, bytes32 key, uint256 _index, bytes21 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * (checked only to prevent modifying other tables; can corrupt own data if index overflows)
   */
  function _updateValue(bytes32 _tableId, bytes32 key, uint256 _index, bytes21 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * (checked only to prevent modifying other tables; can corrupt own data if index overflows)
   */
  function updateValue(IStore _store, bytes32 _tableId, bytes32 key, uint256 _index, bytes21 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
