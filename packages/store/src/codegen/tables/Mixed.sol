...
library Mixed {
  ...
  function setU32(bytes32 key, uint32 u32) internal {
    ...
    StoreSwitch.setField(_tableId, _keySchema, 0, abi.encodePacked((u32)));
  }
  ...
  function setU32(IStore _store, bytes32 key, uint32 u32) internal {
    ...
    _store.setField(_tableId, _keySchema, 0, abi.encodePacked((u32)));
  }
  ...
  function setU128(bytes32 key, uint128 u128) internal {
    ...
    StoreSwitch.setField(_tableId, _keySchema, 1, abi.encodePacked((u128)));
  }
  ...
  function setU128(IStore _store, bytes32 key, uint128 u128) internal {
    ...
    _store.setField(_tableId, _keySchema, 1, abi.encodePacked((u128)));
  }
  ...
  function setA32(bytes32 key, uint32[] memory a32) internal {
    ...
    StoreSwitch.setField(_tableId, _keySchema, 2, EncodeArray.encode((a32)));
  }
  ...
  function setA32(IStore _store, bytes32 key, uint32[] memory a32) internal {
    ...
    _store.setField(_tableId, _keySchema, 2, EncodeArray.encode((a32)));
  }
  ...
  function getItemA32(bytes32 key, uint256 _index) internal view returns (uint32) {
    ...
    bytes memory _blob = StoreSwitch.getFieldSlice(_tableId, _keySchema, 2, getSchema(), _index * 4, (_index + 1) * 4);
    return (uint32(Bytes.slice4(_blob, 0)));
  }
  ...
  function getItemA32(IStore _store, bytes32 key, uint256 _index) internal view returns (uint32) {
    ...
    bytes memory _blob = _store.getFieldSlice(_tableId, _keySchema, 2, getSchema(), _index * 4, (_index + 1) * 4);
    return (uint32(Bytes.slice4(_blob, 0)));
  }
  ...
  function popA32(bytes32 key) internal {
    ...
    StoreSwitch.popFromField(_tableId, _keySchema, 2, 4);
  }
  ...
  function popA32(IStore _store, bytes32 key) internal {
    ...
    _store.popFromField(_tableId, _keySchema, 2, 4);
  }
  ...
  function updateA32(bytes32 key, uint256 _index, uint32 _element) internal {
    ...
    StoreSwitch.updateInField(_tableId, _keySchema, 2, _index * 4, abi.encodePacked((_element)));
  }
  ...
  function updateA32(IStore _store, bytes32 key, uint256 _index, uint32 _element) internal {
    ...
    _store.updateInField(_tableId, _keySchema, 2, _index * 4, abi.encodePacked((_element)));
  }
  ...
  function setS(bytes32 key, string memory s) internal {
    ...
    StoreSwitch.setField(_tableId, _keySchema, 3, bytes((s)));
  }
  ...
  function setS(IStore _store, bytes32 key, string memory s) internal {
    ...
    _store.setField(_tableId, _keySchema, 3, bytes((s)));
  }
  ...
  function getItemS(bytes32 key, uint256 _index) internal view returns (string memory) {
    ...
    bytes memory _blob = StoreSwitch.getFieldSlice(_tableId, _keySchema, 3, getSchema(), _index * 1, (_index + 1) * 1);
    return (string(_blob));
  }
  ...
  function getItemS(IStore _store, bytes32 key, uint256 _index) internal view returns (string memory) {
    ...
    bytes memory _blob = _store.getFieldSlice(_tableId, _keySchema, 3, getSchema(), _index * 1, (_index + 1) * 1);
    return (string(_blob));
  }
  ...
  function pushS(bytes32 key, string memory _slice) internal {
    ...
    StoreSwitch.pushToField(_tableId, _keySchema, 3, bytes((_slice)));
  }
  ...
  function pushS(IStore _store, bytes32 key, string memory _slice) internal {
    ...
    _store.pushToField(_tableId, _keySchema, 3, bytes((_slice)));
  }
  ...
  function popS(bytes32 key) internal {
    ...
    StoreSwitch.popFromField(_tableId, _keySchema, 3, 1);
  }
  ...
  function popS(IStore _store, bytes32 key) internal {
    ...
    _store.popFromField(_tableId, _keySchema, 3, 1);
  }
  ...
  function updateS(bytes32 key, uint256 _index, string memory _slice) internal {
    ...
    StoreSwitch.updateInField(_tableId, _keySchema, 3, _index * 1, bytes((_slice)));
  }
  ...
  function updateS(IStore _store, bytes32 key, uint256 _index, string memory _slice) internal {
    ...
    _store.updateInField(_tableId, _keySchema, 3, _index * 1, bytes((_slice)));
  }
