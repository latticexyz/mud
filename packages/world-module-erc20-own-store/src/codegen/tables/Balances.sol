...
library Balances {
   ...
   * @notice Get balance.
   */
  function getBalance(address account) internal view returns (uint256 balance) {
   ...
   * @notice Get balance.
   */
  function get(address account) internal view returns (uint256 balance) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(account)));
   ...
   * @notice Get balance.
   */
  function _get(address account) internal view returns (uint256 balance) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(account)));
   ...
   * @notice Set balance.
   */
  function set(address account, uint256 balance) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(account)));
   ...
   * @notice Set balance.
   */
  function _set(address account, uint256 balance) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160(account)));
