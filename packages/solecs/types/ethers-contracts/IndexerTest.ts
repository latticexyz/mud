...
export interface IndexerTestInterface extends utils.Interface {
  contractName: "IndexerTest";
  functions: {
    ...
    "testSetAndGetEntitiesWithValue()": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "testSetAndGetEntitiesWithValue", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "testSetAndGetEntitiesWithValue", data: BytesLike): Result;
...
export interface IndexerTest extends BaseContract {
  contractName: "IndexerTest";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IndexerTestInterface;
  ...
  callStatic: {
    ...
    testSetAndGetEntitiesWithValue(overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    testSetAndGetEntitiesWithValue(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
