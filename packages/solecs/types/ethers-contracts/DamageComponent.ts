...
export interface DamageComponent extends BaseContract {
  ...
  functions: {
    ...
    "getEntitiesWithValue(uint256)"(value: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber[]]>;
  ...
  populateTransaction: {
    ...
    "getEntitiesWithValue(uint256)"(value: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
