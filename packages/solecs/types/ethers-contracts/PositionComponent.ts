...
export interface PositionComponentInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "getEntitiesWithValue", values: [PositionStruct]): string;
  ...
  encodeFunctionData(functionFragment: "set", values: [BigNumberish, PositionStruct]): string;
...
export interface PositionComponent extends BaseContract {
  ...
  functions: {
    ...
    "getEntitiesWithValue((int64,int64))"(value: PositionStruct, overrides?: CallOverrides): Promise<[BigNumber[]]>;
    ...
    getValue(entity: BigNumberish, overrides?: CallOverrides): Promise<[PositionStructOutput]>;
  ...
  callStatic: {
    ...
    "set(uint256,(int64,int64))"(entity: BigNumberish, value: PositionStruct, overrides?: CallOverrides): Promise<void>;
