...
library Perlin3 {
  ...
  // TODO: convert into if/else statements like Perlin2
  // TODO: handle negative index i
  function p2(int64 i) public view returns (int64) {
    uint8[512] memory permutation = [
      151,
      160,
      137,
      91,
    ...
    return int64(uint64(permutation[uint256(int256(i))]));
  }
}
