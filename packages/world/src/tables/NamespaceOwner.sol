...
library NamespaceOwner {
  ...
  function set(bytes16 namespace, address owner) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 0, abi.encodePacked((owner)), getValueFieldLayout());
  }
  ...
  function set(IStore _store, bytes16 namespace, address owner) internal {
    ...
    _store.setField(_tableId, _keyTuple, 0, abi.encodePacked((owner)), getValueFieldLayout());
  }
