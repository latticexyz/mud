...
library Delegations {
  ...
  function set(address delegator, address delegatee, bytes32 delegationControlId) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 0, abi.encodePacked((delegationControlId)), getValueFieldLayout());
  }
  ...
  function set(IStore _store, address delegator, address delegatee, bytes32 delegationControlId) internal {
    ...
    _store.setField(_tableId, _keyTuple, 0, abi.encodePacked((delegationControlId)), getValueFieldLayout());
  }
