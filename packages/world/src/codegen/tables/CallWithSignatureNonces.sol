...
library CallWithSignatureNonces {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "world", name: "CallWithSignatur", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462776f726c6400000000000000000043616c6c576974685369676e61747572);
