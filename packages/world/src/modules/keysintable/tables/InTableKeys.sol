...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("InTableKeys")));
bytes32 constant InTableKeysTableId = _tableId;
...
library InTableKeys {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("InTableKeys", _fieldNames);
  }
