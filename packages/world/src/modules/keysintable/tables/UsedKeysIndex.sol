...
library UsedKeysIndex {
  ...
  function setHas(bytes32 sourceTable, bytes32 keysHash, bool has) internal {
    ...
    StoreSwitch.setField(_tableId, _keySchema, 0, abi.encodePacked((has)));
  }
  ...
  function setHas(IStore _store, bytes32 sourceTable, bytes32 keysHash, bool has) internal {
    ...
    _store.setField(_tableId, _keySchema, 0, abi.encodePacked((has)));
  }
  ...
  function setIndex(bytes32 sourceTable, bytes32 keysHash, uint32 index) internal {
    ...
    StoreSwitch.setField(_tableId, _keySchema, 1, abi.encodePacked((index)));
  }
  ...
  function setIndex(IStore _store, bytes32 sourceTable, bytes32 keysHash, uint32 index) internal {
    ...
    _store.setField(_tableId, _keySchema, 1, abi.encodePacked((index)));
  }
  ...
  function encodeKeyTuple(bytes32 sourceTable, bytes32 keysHash) internal pure returns (bytes32[] memory _keySchema) {
