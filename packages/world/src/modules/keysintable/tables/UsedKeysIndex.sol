...
library UsedKeysIndex {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory, string[] memory) {
    ...
    _valueSchemaNames[0] = "has";
    _valueSchemaNames[1] = "index";
    string[] memory _keySchemaNames = new string[](2);
    _keySchemaNames[0] = "sourceTable";
    _keySchemaNames[1] = "keysHash";
    return ("UsedKeysIndex", _valueSchemaNames, _keySchemaNames);
  }
