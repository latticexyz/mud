...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("FactoryContent")));
bytes32 constant FactoryContentTableId = _tableId;

library FactoryContent {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("FactoryContent", _fieldNames);
  }
