...
library KeysWithValue {
  ...
  /** Set keysWithValue */
  function setKeysWithValue(bytes32 _tableId, bytes32 valueHash, bytes32[] memory keysWithValue) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = valueHash;
  ...
  /** Set keysWithValue */
  function _setKeysWithValue(bytes32 _tableId, bytes32 valueHash, bytes32[] memory keysWithValue) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = valueHash;
  ...
  function lengthKeysWithValue(bytes32 _tableId, bytes32 valueHash) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = valueHash;
  ...
  /** Get the length of keysWithValue */
  function _lengthKeysWithValue(bytes32 _tableId, bytes32 valueHash) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = valueHash;
  ...
  function lengthKeysWithValue(IStore _store, bytes32 _tableId, bytes32 valueHash) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = valueHash;
   ...
   */
  function getItemKeysWithValue(bytes32 _tableId, bytes32 valueHash, uint256 _index) internal view returns (bytes32) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = valueHash;
   ...
   * (unchecked, returns invalid data if index overflows)
   */
  function _getItemKeysWithValue(bytes32 _tableId, bytes32 valueHash, uint256 _index) internal view returns (bytes32) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = valueHash;
  ...
  function pushKeysWithValue(bytes32 _tableId, bytes32 valueHash, bytes32 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = valueHash;
  ...
  /** Push an element to keysWithValue */
  function _pushKeysWithValue(bytes32 _tableId, bytes32 valueHash, bytes32 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = valueHash;
  ...
  function pushKeysWithValue(IStore _store, bytes32 _tableId, bytes32 valueHash, bytes32 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = valueHash;
  ...
  function popKeysWithValue(bytes32 _tableId, bytes32 valueHash) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = valueHash;
  ...
  /** Pop an element from keysWithValue */
  function _popKeysWithValue(bytes32 _tableId, bytes32 valueHash) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = valueHash;
  ...
  function popKeysWithValue(IStore _store, bytes32 _tableId, bytes32 valueHash) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = valueHash;
   ...
   */
  function updateKeysWithValue(bytes32 _tableId, bytes32 valueHash, uint256 _index, bytes32 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = valueHash;
   ...
   * (checked only to prevent modifying other tables; can corrupt own data if index overflows)
   */
  function _updateKeysWithValue(bytes32 _tableId, bytes32 valueHash, uint256 _index, bytes32 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = valueHash;
