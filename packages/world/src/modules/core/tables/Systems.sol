...
library Systems {
  ...
  function setSystem(bytes32 resourceSelector, address system) internal {
    ...
    StoreSwitch.setField(_tableId, _keySchema, 0, abi.encodePacked((system)));
  }
  ...
  function setSystem(IStore _store, bytes32 resourceSelector, address system) internal {
    ...
    _store.setField(_tableId, _keySchema, 0, abi.encodePacked((system)));
  }
  ...
  function setPublicAccess(bytes32 resourceSelector, bool publicAccess) internal {
    ...
    StoreSwitch.setField(_tableId, _keySchema, 1, abi.encodePacked((publicAccess)));
  }
  ...
  function setPublicAccess(IStore _store, bytes32 resourceSelector, bool publicAccess) internal {
    ...
    _store.setField(_tableId, _keySchema, 1, abi.encodePacked((publicAccess)));
  }
  ...
  function encodeKeyTuple(bytes32 resourceSelector) internal pure returns (bytes32[] memory _keySchema) {
