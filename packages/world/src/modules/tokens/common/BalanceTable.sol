...
library BalanceTable {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    return ("BalanceTable", _fieldNames);
  }
  ...
  /** Get balance */
  function get(bytes32 _tableId, address id) internal view returns (uint256 balance) {
  ...
  function get(IStore _store, bytes32 _tableId, address id) internal view returns (uint256 balance) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((id))));
  ...
  /** Set balance */
  function set(bytes32 _tableId, address id, uint256 balance) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((id))));
  ...
  function set(IStore _store, bytes32 _tableId, address id, uint256 balance) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((id))));
