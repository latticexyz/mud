export default [
  {
    ...
    outputs: [{ name: "returnDatas", type: "bytes[]", internalType: "bytes[]" }],
  ...
  },
  {
    ...
    name: "call",
    inputs: [
      { name: "systemId", type: "bytes32", internalType: "ResourceId" },
      { name: "callData", type: "bytes", internalType: "bytes" },
    ],
  ...
  },
  {
    ...
    name: "deleteRecord",
    inputs: [
      { name: "tableId", type: "bytes32", internalType: "ResourceId" },
  ...
  },
  {
    ...
    inputs: [
      { name: "tableId", type: "bytes32", internalType: "ResourceId" },
      { name: "keyTuple", type: "bytes32[]", internalType: "bytes32[]" },
      { name: "dynamicFieldIndex", type: "uint8", internalType: "uint8" },
    ],
    outputs: [{ name: "", type: "bytes", internalType: "bytes" }],
    stateMutability: "view",
  },
  ...
  },
  {
    ...
    inputs: [
      { name: "tableId", type: "bytes32", internalType: "ResourceId" },
      { name: "keyTuple", type: "bytes32[]", internalType: "bytes32[]" },
      { name: "fieldIndex", type: "uint8", internalType: "uint8" },
      {
        name: "fieldLayout",
        type: "bytes32",
  ...
  },
  {
    type: "function",
    name: "getFieldLayout",
    inputs: [{ name: "tableId", type: "bytes32", internalType: "ResourceId" }],
    outputs: [
      {
        name: "fieldLayout",
        type: "bytes32",
  ...
  },
  {
    ...
    name: "getKeySchema",
    inputs: [{ name: "tableId", type: "bytes32", internalType: "ResourceId" }],
    outputs: [{ name: "keySchema", type: "bytes32", internalType: "Schema" }],
    stateMutability: "view",
  },
  {
    type: "function",
  ...
  },
  {
    ...
    name: "getValueSchema",
    inputs: [{ name: "tableId", type: "bytes32", internalType: "ResourceId" }],
    outputs: [{ name: "valueSchema", type: "bytes32", internalType: "Schema" }],
    stateMutability: "view",
  },
  {
    type: "function",
    name: "grantAccess",
    inputs: [
      { name: "resourceId", type: "bytes32", internalType: "ResourceId" },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "encodedArgs", type: "bytes", internalType: "bytes" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "keyTuple", type: "bytes32[]", internalType: "bytes32[]" },
      { name: "dynamicFieldIndex", type: "uint8", internalType: "uint8" },
      { name: "dataToPush", type: "bytes", internalType: "bytes" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  ...
  },
  {
    ...
    inputs: [{ name: "namespaceId", type: "bytes32", internalType: "ResourceId" }],
    outputs: [],
    stateMutability: "nonpayable",
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "enabledHooksBitmap", type: "uint8", internalType: "uint8" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  {
    ...
    inputs: [
      ...
      { name: "publicAccess", type: "bool", internalType: "bool" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "keySchema", type: "bytes32", internalType: "Schema" },
      { name: "valueSchema", type: "bytes32", internalType: "Schema" },
      { name: "keyNames", type: "string[]", internalType: "string[]" },
      { name: "fieldNames", type: "string[]", internalType: "string[]" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "deleteCount", type: "uint40", internalType: "uint40" },
      { name: "data", type: "bytes", internalType: "bytes" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    ...
    name: "storeVersion",
    inputs: [],
    outputs: [{ name: "version", type: "bytes32", internalType: "bytes32" }],
    stateMutability: "view",
  },
  {
    type: "function",
  ...
  },
  {
    ...
    inputs: [
      { name: "numFields", type: "uint256", internalType: "uint256" },
      { name: "maxFields", type: "uint256", internalType: "uint256" },
    ],
  },
  {
    type: "error",
  ...
  { type: "error", name: "Module_RootInstallNotSupported", inputs: [] },
  {
    type: "error",
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "accessedIndex", type: "uint256", internalType: "uint256" },
    ],
  },
  {
    type: "error",
  ...
  },
  {
    ...
    inputs: [
      { name: "expected", type: "bytes2", internalType: "bytes2" },
      { name: "resourceId", type: "bytes32", internalType: "ResourceId" },
      { name: "resourceIdString", type: "string", internalType: "string" },
    ],
  },
  {
    type: "error",
    ...
    inputs: [
      ...
      { name: "deleteCount", type: "uint40", internalType: "uint40" },
      { name: "fieldLength", type: "uint40", internalType: "uint40" },
    ],
  },
  {
    type: "error",
  ...
  },
  {
    ...
    inputs: [
      { name: "tableId", type: "bytes32", internalType: "ResourceId" },
      { name: "tableIdString", type: "string", internalType: "string" },
    ],
  },
  {
    type: "error",
  ...
  },
  {
    ...
    inputs: [{ name: "namespace", type: "bytes14", internalType: "bytes14" }],
  },
  {
    type: "error",
  ...
  },
  {
    ...
    inputs: [{ name: "system", type: "address", internalType: "address" }],
  },
  {
    type: "error",
