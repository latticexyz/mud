...
contract queryTest is Test {
  ...
  function testQuerySingleTable(bytes32[2] memory keys, uint256[2] memory values) public {
  ...
  function testQueryTwoTables12(bytes32[2] memory keys, uint256[2] memory values) public {
    vm.assume(keys[0] != keys[1]);
  ...
  function testQueryTwoTables22(bytes32[2] memory keys, uint256[2] memory values) public {
    vm.assume(keys[0] != keys[1]);
