...
export interface KeysWithValueModuleInterface extends utils.Interface {
  functions: {
...
export interface KeysWithValueModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KeysWithValueModuleInterface;
