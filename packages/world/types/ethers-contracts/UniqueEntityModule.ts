...
export interface UniqueEntityModuleInterface extends utils.Interface {
  functions: {
...
export interface UniqueEntityModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UniqueEntityModuleInterface;
