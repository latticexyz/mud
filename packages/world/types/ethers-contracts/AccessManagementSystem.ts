...
export interface AccessManagementSystemInterface extends utils.Interface {
  functions: {
...
export interface AccessManagementSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AccessManagementSystemInterface;
