...
library Counter {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "counter", name: "Counter", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462636f756e74657200000000000000436f756e746572000000000000000000);
