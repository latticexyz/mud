...
export function createSystemCalls(
   ...
   *     https://github.com/latticexyz/mud/blob/main/templates/three/packages/client/src/mud/setupNetwork.ts#L63-L68).
   *
   *   - waitForTransaction (which comes from syncToRecs, see
   *     https://github.com/latticexyz/mud/blob/main/templates/three/packages/client/src/mud/setupNetwork.ts#L77-L83).
   *
