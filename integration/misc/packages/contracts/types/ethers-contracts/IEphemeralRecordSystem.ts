...
export interface IEphemeralRecordSystemInterface extends utils.Interface {
  functions: {
...
export interface IEphemeralRecordSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IEphemeralRecordSystemInterface;
